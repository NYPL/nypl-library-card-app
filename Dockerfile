...
ARG NEXT_PUBLIC_DS_GLOBAL_HEADER
ARG NEXT_PUBLIC_DS_GLOBAL_FOOTER
ENV NEXT_PUBLIC_DS_GLOBAL_HEADER $NEXT_PUBLIC_DS_GLOBAL_HEADER
ENV NEXT_PUBLIC_DS_GLOBAL_FOOTER $NEXT_PUBLIC_DS_GLOBAL_FOOTER
