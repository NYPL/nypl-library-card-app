...
describe("LanguageMenu", () => {
  ...
  it("it renders a list of links", () => {
    ...
    expect(links[0]).toHaveAttribute("href", "/library-card/new?lang=ar");
    expect(links[1].textContent).toContain("Bengali");
    expect(links[1]).toHaveAttribute("href", "/library-card/new?lang=bn");
    expect(links[2].textContent).toContain("Chinese");
    expect(links[2]).toHaveAttribute("href", "/library-card/new?lang=zhcn");
    expect(links[3].textContent).toContain("English");
    expect(links[3]).toHaveAttribute("href", "/library-card/new?lang=en");
    expect(links[4].textContent).toContain("French");
    expect(links[4]).toHaveAttribute("href", "/library-card/new?lang=fr");
    expect(links[5].textContent).toContain("Haitian Creole");
    expect(links[5]).toHaveAttribute("href", "/library-card/new?lang=ht");
    expect(links[6].textContent).toContain("Korean");
    expect(links[6]).toHaveAttribute("href", "/library-card/new?lang=ko");
    expect(links[7].textContent).toContain("Polish");
    expect(links[7]).toHaveAttribute("href", "/library-card/new?lang=pl");
    expect(links[8].textContent).toContain("Russian");
    expect(links[8]).toHaveAttribute("href", "/library-card/new?lang=ru");
    expect(links[9].textContent).toContain("Spanish");
    expect(links[9]).toHaveAttribute("href", "/library-card/new?lang=es");
