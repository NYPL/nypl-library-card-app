    ...
    confirmation: {
      ...
      nextSteps: {
        ...
        more: {
          header: "Learn more",
          content:
            "<a href='https://www.nypl.org/discover-library-card'>Discover everything you can do with your library card.</a>",
        },
      },
    },
    ariaLabel: {
